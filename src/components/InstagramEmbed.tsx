        ...
        <section className={styles.section} id="conteudo">
            <div className={styles.container}>
                <div className={styles.header}>
                    <h2 className={styles.title}>Conteúdo e Vídeos</h2>
                ...
                <div className={styles.embedContainer}>
                    <blockquote
                        ...
                        data-instgrm-permalink="https://www.instagram.com/reel/DagfZDQJIuy/?utm_source=ig_embed&amp;utm_campaign=loading"
                    ...
                    >
                        <div style={{ padding: '16px' }}>
                            <a
                                href="https://www.instagram.com/reel/DagfZDQJIuy/?utm_source=ig_embed&amp;utm_campaign=loading"
                            ...
                            <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                <a href="https://www.instagram.com/reel/DagfZDQJIuy/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">
                                    Um post compartilhado por Renata Ribeiro | NeuroPsicóloga TEA/TDAH Adulto (@psic.renataribeiro)
                                </a>
                            </p>
                        </div>
                    </blockquote>
